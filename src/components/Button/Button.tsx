import { ButtonProps } from "../../App.modal";
import { StyledButton } from "./button.styled";

export default function Button({ symbol, text, background }: ButtonProps) {
  return (
    <>
      <StyledButton $symbol={symbol} $background={background}>
        {symbol && (
          <svg
            width="22"
            height="23"
            viewBox="0 0 22 23"
            fill={background ? "white" : "var(--orange)"}
